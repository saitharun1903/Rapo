...
public enum ErrorCode {
    ...
    RIDE_NOT_COMPLETED(HttpStatus.CONFLICT),
    AI_ANALYSIS_NOT_REGENERABLE(HttpStatus.CONFLICT),
    ALREADY_RATED(HttpStatus.CONFLICT),
    ERROR_REPORTING_DISABLED(HttpStatus.CONFLICT),
    CHAT_CLOSED(HttpStatus.CONFLICT),
