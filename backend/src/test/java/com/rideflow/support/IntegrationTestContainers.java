...
/**
 * Singleton PostgreSQL + PostGIS and Redis containers shared by every integration test class in the JVM, so
 * cached Spring contexts never point at a stopped container. Tests are skipped, not failed, on machines
