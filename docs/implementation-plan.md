...
| 3 Ride system | 🟡 Code complete, CI pending | 120 unit tests pass locally; 16 new PostGIS integration tests (lifecycle, accept race, expiry, proximity query) run in CI |
