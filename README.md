...
> **Status: Phase 5 (Redis).** Auth, driver onboarding, fares, PostGIS driver matching, the full ride lifecycle, the STOMP/WebSocket real-time channel, and Redis caching and rate limiting (with [measured before/after numbers](docs/performance.md)) are implemented and verified in CI. See the [implementation plan](docs/implementation-plan.md#progress). The full README will be written in Phase 15.
